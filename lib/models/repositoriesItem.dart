...
import 'package:desafio/models/license.dart';
import 'package:desafio/models/owner.dart';

class RepositoriesItemsModel {
  int id;
  String nodeId;
  String name;
  String fullName;
  ...
  RepositoriesItemsModel.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    nodeId = json['node_id'];
    name = json['name'];
    fullName = json['full_name'];
    private = json['private'];
    owner = json['owner'] != null ? new OwnerModel.fromJson(json['owner']) : null;
    ...
    license =
        json['license'] != null ? new LicenseModel.fromJson(json['license']) : null;
